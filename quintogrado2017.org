...
Eje: ¿Quiénes eran los caudillos? ¿Por qué se enfrentan las provincias? ¿Cuales son las causas de las luchas entre unitarios y federales?</td>
    <td>(Escala Argentina) Valoración de elementos naturales
1. Recursos mineros (oro, litio), forestales (avance de la frontera agropecuaria bosque chaqueños). suelo (oasis mendocinos), faunísticos (guanacos)
2. El mismo recurso, explotaciones diferentes: Suelo (Actores sociales, Benetton y crianceros). Agua (regadío y electricidad)

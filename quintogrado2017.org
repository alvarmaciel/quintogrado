...
- Ortografía literal
  ...
  - R ELACIÓN ENTRE ORTOGRAFÍA , MORFOLOGÍA Y SEMÁNTICA | A FIJOS
...
- Uso de mayúsculas y minúsculas
  - Mayúsculas en nombres propios compuestos (Mar del Plata, San Cle-mente del Tuyú, La Pampa).
  - Minúsculas en títulos y tratamientos no abreviados.
  - Mayúsculas en títulos y tratamien-tos abreviados (Dr., Sr.).
